...
#include "isim/work/array1/array1.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_btest_vhd_behavior(const char*);
        topvh = createWork_btest_vhd_behavior("btest_vhd");
...
main(int argc, char **argv) {
  ...
  try {
    ...
    WorkArray1=new Work_array1("array1");
    HSimConfigDecl *cfg;
 _top_i = new _top();
